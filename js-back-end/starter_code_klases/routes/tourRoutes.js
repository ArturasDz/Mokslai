...
const TourValidate = require('../validators/TourValidate');
...
router
  ...
  .post(TourValidate, validate, createTour); // General base route
router
.route('/filter')
.get(filterValidator, validate, getFilteredTours);
